package com.evermodel.service.agg.aidemo.model;
...
/**
 * A model that uses the OpenAI Chat API to generate responses.
 * 替换掉spring ai提供的默认的openai client，
 * alibaba 千问模型的openai兼容性存在小瑕疵，所以这里继承了spring ai的openai client，并做了修改
 */
